...
<body>
	...
	<c:if test="${empty favorite}">
		<div style="margin-left: 600px; margin-top: 100px">
			<img src="${pageContext.request.contextPath}/img/favite.jpg" />
			<h4 style="margin-left: 170px">
				<strong>空空如也！快去把喜欢的宝贝添加进收藏夹吧！！！</strong> <a
					href="${pageContext.request.contextPath}/client/ClientServlet?op=category">返回主页</a>
			</h4>
		</div>
	</c:if>
	<c:if test="${!empty favorite}">
			...
			<c:forEach items="${favorite}" var="f" varStatus="vs">
				<tr class="active">
					...
					<td><img style="width: 80px; height: 100px"
						src="${pageContext.request.contextPath}/images/${f.book.path}/${f.book.filename}" />
					</td>
