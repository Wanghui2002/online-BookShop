        ...
        <div id="carousel-example-generic" class="carousel slide"
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <img src="${pageContext.request.contextPath}/img/lb_01.jpg" style="width: 100%;">
                ...
                <div class="item">
                    <img src="${pageContext.request.contextPath}/img/lb_02.jpg" style="width: 100%;">
                    <div class="carousel-caption">
                        <!-- 轮播图上的文字 -->
                        网上书店
                    </div>
                ...
                <div class="item">
                    <img src="${pageContext.request.contextPath}/img/lb_03.jpg" style="width: 100%;">
                    <div class="carousel-caption">
                        <!-- 轮播图上的文字 -->
                        网上书店
                    </div>
                ...
                <div class="item">
                    <img src="${pageContext.request.contextPath}/img/lb_04.jpg" style="width: 100%;">
                    <div class="carousel-caption">
                        <!-- 轮播图上的文字 -->
                      	  网上书店
                    </div>
                ...
                <div class="item">
                    <img src="${pageContext.request.contextPath}/img/lb_05.jpg" style="width: 100%;">
                    <div class="carousel-caption">
                        <!-- 轮播图上的文字 -->
