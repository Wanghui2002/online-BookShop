...
<body>
	...
	<div style="margin-top: 30px; margin-left: 430px">
		<form action="${pageContext.request.contextPath}/admin/ManagerServlet?op=editBook"
			...
			<div class="form-group">
				<label>书籍分类：</label> <select class="form-control" id="categoryid" name="categoryid"
					title="书籍分类" style="width: 700px">
					<option selected="selected" value="${map.book.category.category_id}">${map.book.category.category_name}</option>
			...
			<div class="form-group">
				<label for="exampleInputFile">图片上传：</label> <img
					...
					src="${pageContext.request.contextPath}/images/${map.book.path}/${map.book.filename}" />
			</div>
			<div class="form-group">
				<label>书籍简介：</label>
