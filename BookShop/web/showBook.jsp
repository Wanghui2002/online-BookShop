...
">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="${pageContext.request.contextPath}/client/ClientServlet?op=category">书籍分类</a>
			</div>
			<div class="collapse navbar-collapse"
				 id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					<c:forEach items="${categoryList}" var="c">
						<li><a href="${pageContext.request.contextPath}/client/ClientServlet?op=category&cid=${c.category_id}">${c.category_name}</a></li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					</c:forEach>
				</ul>
				<!-- 搜索框 -->
				<div style="float: right; margin-right: 7px">
					<form class="navbar-form navbar-left"
						  action="${pageContext.request.contextPath}/client/ClientServlet?op=search" method="post">
						<div class="form-group">
							<input type="text" name="search" class="form-control"
								   placeholder="搜索/书籍名称" value="${name}">
						</div>
	...
	<table class="table table-bordered table-hover"
		...
		<c:forEach items="${books}" var="s" varStatus="vs">
			<tr class="active">
				...
				<td><a
					href="${pageContext.request.contextPath}/client/ClientServlet?op=particulars&book_id=${s.book_id}">详情</a></td>
			</tr>
		</c:forEach>
	</table>
