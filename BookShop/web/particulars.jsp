...
<script type="text/javascript">
    window.onload = function () {
       $("#bt1").click(function(){
         	location.href="../client/ClientServlet?op=addCart&book_id=${book.book_id}"   
       })
...
<div
    ...
    <div style="width: 640px; height: 600px; float: right;">
        ...
        <div
            ...
            <img alt="bg——img" src="${pageContext.request.contextPath}/img/seckilling.png">
            ...
            <div style="margin-top: 20px; margin-left: 25px">
                <a id="a1" href="#" onclick="javascript:favorite();return false;"
                   style="text-decoration: none; color: black"><img
                        src="${pageContext.request.contextPath}/img/shoucang.png"
...
<script type="text/javascript">
    ...
    $("#bt2").click(function(){
    	location.href="${pageContext.request.contextPath}/client/ClientServlet?op=buyNow&book_id=${book.book_id}";
    })
</script>
</body>
</html>